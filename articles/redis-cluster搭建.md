...
Redis读写分离服务和Redis Sentinel都只是复制节点数据和故障转移，面对高并发的业务场景，以上两种集群并不能很好的<font color="red">解决单机内存瓶颈、流量瓶颈等非分布式服务常见问题</font>>，分布式Redis服务的重要性并凸显出来了，Redis Cluster 将数据分布到不同节点上,解决单机无法满足内存,并发,带宽等问题：
