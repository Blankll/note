...
![](../../statics/rocketmq/支付流程.png)

<u>通过MQ进行数据分发，提高系统处理性能</u>

![](../../statics/rocketmq/支付成功数据分发流程图.png)
...
![](../../statics/rocketmq/项目初始化.png)

- 父工程：shop-parent<font color="red">(maven)</font>
- 订单系统：shop-order-web<font color="red">(springboot)</font>
- 支付系统：shop-pay-web<font color="red">(springboot)</font>
...
- 实体类：shop-pojo<font color="red">(jar)</font>
- 持久层：shop-dao<font color="red">(jar)</font>
- 接口层：shop-api<font color="red">(jar)</font>
- 工具工程：shop-common<font color="red">(jar)</font>
