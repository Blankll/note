...
docker run --name name -d /bin/bash
...
4. docker inspect web 查看容器的ip地址 

5. docker rmi 删除镜像 一个一个的删除标签，删除完标签后，images也会被删除

6. docker rmi id 就会删除镜像，同时删除镜像对应的所有标签

7. dicker inspect 查看镜像的详细信息
